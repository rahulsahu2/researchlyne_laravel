...
$(function() {
    ...
    var count = getCounterData($("#countdown-timer"));
...
function updateClass() {
    ...
    if (window.location.pathname === '/') {
        mainHeader.classList.remove('bg-color-3');
        mainHeader.classList.add('header-section--style2');
    } else {
        mainHeader.classList.add('bg-color-3');
        mainHeader.classList.remove('header-section--style2');
    }
}
